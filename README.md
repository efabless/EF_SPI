...
Status resgister
<img src="https://svg.wavedrom.com/{reg:[{name:'TX_E', bits:1},{name:'TX_F', bits:1},{name:'RX_F', bits:1},{name:'RX_E', bits:1},{name:'TX_B', bits:1},{name:'RX_A', bits:1},{bits: 26}], config: {lanes: 2, hflip: true}} "/>
